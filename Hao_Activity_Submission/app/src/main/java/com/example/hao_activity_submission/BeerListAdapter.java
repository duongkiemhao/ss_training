...
public class BeerListAdapter extends RecyclerView.Adapter<BeerListAdapter.ViewHolder>{
    ...
    public BeerListAdapter(List<BeerModel> beers, OnItemClickListener onItemClickListener, OnBottomReachedListener onBottomReachedListener, Context context) {
        this.beers = beers;
    ...
    public interface OnItemClickListener {
        void onItemClick(BeerModel beer);
    }
    ...
    public BeerListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.fragment_tab_table_row_1, parent, false);
